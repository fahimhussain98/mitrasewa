package wts.com.mitrsewa.bbpsReportsFragments;
...
import wts.com.mitrsewa.activities.BbpsReportActivity;
import wts.com.mitrsewa.activities.LoginActivity;
import wts.com.mitrsewa.adapters.AllReportAdapter;
import wts.com.mitrsewa.adapters.BbpsReportAdapter;
import wts.com.mitrsewa.models.AllReportsModel;
import wts.com.mitrsewa.retrofit.RetrofitClient;

public class ElectricityReportsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_electricity_reports, container, false);

        inhitViews(view);

        ////////////////////////////////////Select from date, to date and search by

        searchBy = "Electricity";
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (statusCode.equalsIgnoreCase("TXN")) {
                            ...
                            BbpsReportAdapter bbpsReportAdapter = new BbpsReportAdapter(allReportsModelArrayList,getContext()
                                    ,getActivity(),userId,"",deviceId
                            ,deviceInfo,false);
