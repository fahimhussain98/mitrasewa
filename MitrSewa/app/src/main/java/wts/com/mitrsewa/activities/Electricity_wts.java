...
public class Electricity_wts extends AppCompatActivity {
    ...
    Button btnPay;
    TextView tvCostumerName1, tvBillNumber1,
        //    tvBillAmount1,
            tvBilldate, tvBillPeriod, tvBillDueDate, tvWalletBalance;
    EditText tvBillAmount1;
    EditText tvBillAmount2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electricity_wts);
        ...
        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(Electricity_wts.this);
    ...
    private void showTpinDialog() {
        ...
        final AlertDialog addSenderDialog = new AlertDialog.Builder(Electricity_wts.this).create();
    ...
    private void checkTpin(String tpin) {
        final android.app.AlertDialog pDialog = new android.app.AlertDialog.Builder(Electricity_wts.this).create();
                    ...
                    try {
                       ...
                       /* if (responseCode.equalsIgnoreCase("TXN")) {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            // Call payBill with appropriate parameters
                            payBill(customerName, amount);  // Pass the correct values here
                        } else {
                            pDialog.dismiss();
                            String transaction = responseObject.getString("status");
                            showSnackbar(transaction);
    ...
    private void fetchBill() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().fetchBill_wts(AUTH_KEY, userid, deviceId, deviceInfo, serviceType, serviceId, selectedOperatorId,
...
/*
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
                    try {
                        JSONObject responseObject = new JSONObject(String.valueOf(response.body()));
                        Log.d("fetchBill","responseObject:" +responseObject);
                        String responseCode = responseObject.getString("statuscode");
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            final View view1 = LayoutInflater.from(Electricity_wts.this).inflate(R.layout.electricity_bill_dialog_layout, null, false);
                            final AlertDialog builder = new AlertDialog.Builder(Electricity_wts.this).create();
                            ...
                            new AlertDialog.Builder(Electricity_wts.this).setCancelable(false)
                                    .setTitle("Message")
                                    .setMessage(message)
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            ...
                            amount = dataObject.optString("billAmount");
                            dueDate = dataObject.optString("dueDate");
                            customerName = dataObject.optString("consumerName");
                            billNumber = dataObject.optString("billNo", "N/A");


                            if (selectedOperatorId.equalsIgnoreCase("1497")) {
                                showEditableBillDialog(customerName, dueDate, amount, billNumber);
                            } else {
                                showBillDialog(customerName, dueDate, amount, billNumber);
                            }

                            //showBillDialog(customerName, dueDate, amount, billNumber);
                        } else if (responseCode.equalsIgnoreCase("ERR")) {
                            String errorMessage = responseObject.optString("data", "An error occurred.");
                            showErrorDialog(errorMessage);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        showErrorDialog("Failed to parse the response. Please try again later.");
                    }
                } else {
                    showErrorDialog("Received an unexpected response from the server.");
                }
            }

/*
            private void showBillDialog(String customerName, String dueDate, String amount, String billNumber) {
                final View view1 = LayoutInflater.from(Electricity_wts.this).inflate(R.layout.electricity_bill_dialog_layout, null, false);
                final AlertDialog builder = new AlertDialog.Builder(Electricity_wts.this).create();
                builder.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                builder.setCancelable(false);
                ...
                TextView tvCustomerName = view1.findViewById(R.id.tv_customer_name);
                TextView tvBillDate = view1.findViewById(R.id.tv_bill_date);
                TextView tvBillAmount = view1.findViewById(R.id.tv_bill_amount);
                TextView tvDueDate = view1.findViewById(R.id.tv_due_date);
                TextView tvCaNumber = view1.findViewById(R.id.tv_tel);
                Button btnProceedToPay = view1.findViewById(R.id.btn_proceed_to_pay);
                Button btnCancel = view1.findViewById(R.id.btn_cancel);

                // Setting values in the dialog
                tvCustomerName.setText(customerName);
                tvBillDate.setText(dueDate);
                tvBillAmount.setText("fahim " + amount);
                tvDueDate.setText(dueDate);
                tvCaNumber.setText(billNumber);
...
*/
            private void showBillDialog(String customerName, String dueDate, String amount, String billNumber) {
                ...
                btnProceedToPay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // Pass customerName and amount to the payBill() method
                        payBill(customerName, amount);
                    }
                });
            ...
            /*
            private void showEditableBillDialog(String customerName, String dueDate, String amount, String billNumber) {
                final View view1 = LayoutInflater.from(Electricity_wts.this).inflate(R.layout.electricity_bill_response_dialog_second, null, false);
                final AlertDialog builder = new AlertDialog.Builder(Electricity_wts.this).create();
                builder.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                builder.setCancelable(false);
                builder.setView(view1);
                ...
                TextView tvCustomerName = view1.findViewById(R.id.tv_customer_name);
                TextView tvBillDate = view1.findViewById(R.id.tv_bill_date);
                EditText etBillAmount = view1.findViewById(R.id.et_bill_amount_2);  // Make this an EditText to allow editing
                TextView tvDueDate = view1.findViewById(R.id.tv_due_date);
                TextView tvCaNumber = view1.findViewById(R.id.tv_tel);
                Button btnProceedToPay = view1.findViewById(R.id.btn_proceed_to_pay);
                Button btnCancel = view1.findViewById(R.id.btn_cancel);
                ...
                tvCustomerName.setText(customerName);
                tvBillDate.setText(dueDate);
                etBillAmount.setText("₹ " + amount);  // Now editable
                tvDueDate.setText(dueDate);
                tvCaNumber.setText(billNumber);
                ...
                btnProceedToPay.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        // Use the edited amount
                        String newAmount    //this is change
                                = etBillAmount.getText().toString().trim().replace("₹", "").trim();
                        billPaymentLayout.setVisibility(View.VISIBLE);
                        tvBillAmount2.setText("₹ " + newAmount);
                        tvBillNumber1.setText("Bill Number: " + billNumber);
                        tvCostumerName1.setText("Name: " + customerName);
                        tvBillDueDate.setText("Due Date: " + dueDate);
                        btnPay.setText("PAY ₹" + newAmount);
                        builder.dismiss();
                    }
                });
...
*/
            private void showEditableBillDialog(String customerName, String dueDate, String amount, String billNumber) {
                ...
                TextView tvCustomerName = view1.findViewById(R.id.tv_customer_name);
                TextView tvBillDate = view1.findViewById(R.id.tv_bill_date);
                EditText etBillAmount = view1.findViewById(R.id.et_bill_amount_2);  // Editable amount
                TextView tvDueDate = view1.findViewById(R.id.tv_due_date);
                TextView tvCaNumber = view1.findViewById(R.id.tv_tel);
                Button btnProceedToPay = view1.findViewById(R.id.btn_proceed_to_pay);
                Button btnCancel = view1.findViewById(R.id.btn_cancel);
                ...
                tvCustomerName.setText(customerName);
                tvBillDate.setText(dueDate);
                etBillAmount.setText("₹ " + amount);  // Allow the user to edit the amount
                tvDueDate.setText(dueDate);
                tvCaNumber.setText(billNumber);
                ...
                btnProceedToPay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String newAmount = etBillAmount.getText().toString().trim().replace("₹", "").trim();
                        billPaymentLayout.setVisibility(View.VISIBLE);
                        tvBillAmount2.setText("₹ " + newAmount);
                        tvBillNumber1.setText("Bill Number: " + billNumber);
                        tvCostumerName1.setText("Name: " + customerName);
                        ...
                        // Pass customerName and newAmount to the payBill() method
                        payBill(customerName, newAmount);
                    }
                });
            ...
            private void showErrorDialog(String message) {
                new AlertDialog.Builder(Electricity_wts.this)
                        .setTitle("Message")
                        .setCancelable(false)
                        .setMessage(message)
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
   ...
   /* private void payBill() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().WtsBillPay(AUTH_KEY, userid, deviceId, deviceInfo, serviceType, selectedOperatorId,
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN") ) {
                            ...
                            final View view1 = LayoutInflater.from(Electricity_wts.this).inflate(R.layout.electricity_bill_response_dialog, null, false);
                            final AlertDialog builder = new AlertDialog.Builder(Electricity_wts.this).create();
                            builder.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                            builder.setCancelable(false);
                            builder.setView(view1);
   ...
   /*
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                pDialog.dismiss(); // Dismiss the progress dialog early
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        // Check if the response code is "TXN"
                        if (responseCode.equalsIgnoreCase("TXN")) {
                            JSONArray dataArray = responseObject.getJSONArray("data");
                            JSONObject dataObject = dataArray.getJSONObject(0);
                            String status = dataObject.getString("Status");
                            ...
                            // Show success dialog
                            showDialog(status, billNumber, "₹ " + amount, "");
                        }
                        // Check if the response code is "ERR"
                        else if (responseCode.equalsIgnoreCase("ERR")) {
                            String errorMessage = responseObject.getString("data"); // Extract the error message
                            String status = responseObject.getString("status"); // Extract the status

                            // Show error dialog with the message from the API
                            showDialog(status, billNumber, "₹ " + amount, errorMessage);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        // Handle JSON parsing error
                        showGenericErrorDialog("Failed to parse the response.");
                    }
                }
                else {
                    // Handle non-successful response
                    showGenericErrorDialog("Received an unexpected response from the server.");
                }
            }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                pDialog.dismiss();
                showGenericErrorDialog("Request failed: " + t.getMessage());
            }

            // Helper method to show the dialog
            private void showDialog(String status, String billNumber, String amount, String message) {
                final View view1 = LayoutInflater.from(Electricity_wts.this).inflate(R.layout.electricity_bill_response_dialog, null, false);
                final AlertDialog builder = new AlertDialog.Builder(Electricity_wts.this).create();
                builder.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                builder.setCancelable(false);
   ...
   private void payBill(String customerName, String amount) {
       final android.app.AlertDialog pDialog = new android.app.AlertDialog.Builder(Electricity_wts.this).create();
       LayoutInflater inflater = getLayoutInflater();
       View convertView = inflater.inflate(R.layout.custom_progress_dialog, null);
       pDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
    ...
    private void getOperators() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().getOperators(AUTH_KEY, deviceId, deviceInfo, userid, operatorServiceId);  //operatorserviceId phele wali screen se ayega
        call.enqueue(new Callback<JsonObject>() {
            @Override
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
                    try {
                        ...
                        tvOperator.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                operatorDialog = new SpinnerDialog(Electricity_wts.this, operatorNameList, "Select Operator", in.galaxyofandroid.spinerdialog.R.style.DialogAnimations_SmileWindow, "Close  ");// With 	Animation
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        tvSubDivisionCode.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                SpinnerDialog SubDivisionDialog = new SpinnerDialog(Electricity_wts.this, subDivisionList, "Sub Division", in.galaxyofandroid.spinerdialog.R.style.DialogAnimations_SmileWindow, "Close  ");// With 	Animation
    ...
    private void inhitViews() {
        ...
        tvBillAmount2 = findViewById(R.id.et_bill_amount2);
