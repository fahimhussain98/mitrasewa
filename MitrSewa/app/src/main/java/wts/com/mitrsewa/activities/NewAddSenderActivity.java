...
public class NewAddSenderActivity extends AppCompatActivity {
    ImageView imgClose;
    TextView tvMobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_add_sender);
        ...
        sharedPreferences= PreferenceManager.getDefaultSharedPreferences(NewAddSenderActivity.this);
    ...
    private void addSender() {
        final android.app.AlertDialog pDialog = new android.app.AlertDialog.Builder(NewAddSenderActivity.this).create();
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (responseCode.equalsIgnoreCase("TXN") || responseCode.equalsIgnoreCase("ERR")) {
                            ...
                            new AlertDialog.Builder(NewAddSenderActivity.this).
                                    setTitle("Message")
                                    .setMessage(message)
                                    .setCancelable(false)
    ...
    private void showAddSenderOtpDialog() {
        ...
        addSenderOTPDialog = new AlertDialog.Builder(NewAddSenderActivity.this).create();
