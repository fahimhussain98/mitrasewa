...
public class AllReportFragment extends Fragment {
    ...
    String transactionId, operatorName, number, amount, commission, cost, balance, dateTime, status, stype, openingBalance, closingBalance,
    uniqueId,liveId;
                        ...
                        if (statusCode.equalsIgnoreCase("TXN")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                               ...
                               String gst = jsonObject.getString("GST");
                                String sur = jsonObject.getString("SURCHARGE");
                                ...
                                allReportsModel.setSurcharge(sur);
                                allReportsModel.setGst(gst);
                                allReportsModel.setTds(tds);
